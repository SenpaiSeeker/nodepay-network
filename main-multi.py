...
DOMAIN_API = {"SESSION": "https://api.nodepay.ai/api/auth/session", "PING": "http://52.77.10.116/api/network/ping"}
...
async def call_api(url, data, proxy, token):
    ...
    try:
        ...
        response = scraper.post(url, json=data, headers=headers, proxies={"http": proxy, "https": proxy}, timeout=15)
